...
const filteredMovies = computed(() => {
  if (selectedGenre.value) {
    return props.movies.filter(movie => movie.genre === selectedGenre.value)
  }
  return props.movies
})
...
function filterMovies() {
  if (selectedGenre.value) {
    return $inertia.visit(route('movies.index', { genre: selectedGenre.value }))
  }
  return $inertia.visit(route('movies.index'))
}
</script>
